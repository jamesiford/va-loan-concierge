...
const EVENT_CONFIG = {
  ...
  calculator_note:         { label: 'Calculator Note',   color: '#B45309', bg: '#FFFBEB', border: '#FDE68A', icon: '⚠' },
  ...
  scheduler_note:          { label: 'Scheduler Note',    color: '#B45309', bg: '#FFFBEB', border: '#FDE68A', icon: '⚠' },
  ...
  newsletter_start:        { label: 'Newsletter Agent',  color: '#065F46', bg: '#ECFDF5', border: '#6EE7B7', icon: '📰' },
  newsletter_tool_call:    { label: 'KB Query',          color: '#065F46', bg: '#ECFDF5', border: '#6EE7B7', icon: '🔍' },
  newsletter_tool_result:  { label: 'Digest Ready',      color: '#15803D', bg: '#F0FDF4', border: '#BBF7D0', icon: '✓' },
  newsletter_complete:     { label: 'Newsletter Agent',  color: '#065F46', bg: '#ECFDF5', border: '#6EE7B7', icon: '📰' },
  await_input:             { label: 'Waiting for You',    color: '#7C3AED', bg: '#F5F3FF', border: '#DDD6FE', icon: '💬' },
