...
ADVISOR_INSTRUCTIONS = (
    ...
    "  1. Policy documents (va_guidelines.md, lender_products.md, loan_process_faq.md) — "
    "authoritative VA rules, lender products, and borrower FAQs.\n"
    "  2. Live news index (va-loan-news) — recent VA rate changes, policy updates, and "
    "industry news ingested from official feeds (VA.gov, CFPB, Freddie Mac, MBA). "
    ...
    "(e.g. va_guidelines.md, lender_products.md, loan_process_faq.md, 'Freddie Mac PMMS — "
